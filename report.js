...
function WriteToFile() {
    ...
    set s = fso.CreateTextFile('C:\Users\MERWIN MIGHTY\Desktop\plugin\test.txt', True);
...
function infocollector(){
    error = document.getElementById("text1").value;
    activity = document.getElementById("text2").value;
    suggestion = document.getElementById("text3").value;
    WriteToFile();
    console.log(error);
    console.log(activity);
    console.log(suggestion);
}
document.getElementById("submit").addEventListener("click",infocollector);